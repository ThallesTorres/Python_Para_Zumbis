...
# Versão do Professor (função 'sum' is broken!)
# 'sum' não retorna o erro caso tenha 0 elemento, caso tenha 1 retorna somente ele
    return sum(nums[:2])
...
def squirrel_play(temp, is_summer):
    ...
    if is_summer:
        time += 10
    return temp in range(60, time)

# Versão do Professor (melhorada)
